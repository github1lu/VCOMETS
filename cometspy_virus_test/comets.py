...
class comets:
    ...
    def __init__(self, layout,
        ...
        #Delethed the + '_' + hex(id(self) part in the name. Was appending it in a series of runs, creating too long names. Ilija Dukovski 02/17/2022
        self.parameters.set_param("TotalBiomassLogName", self.parameters.all_params['TotalBiomassLogName'])
        self.parameters.set_param("BiomassLogName", self.parameters.all_params['BiomassLogName'])
        self.parameters.set_param("FluxLogName", self.parameters.all_params['FluxLogName'])
        self.parameters.set_param("MediaLogName", self.parameters.all_params['MediaLogName'])
	...
	# write the files for comets in working_dir
        ...
        if platform.system() == 'Windows':
            ...
            # simulate
            print("HERE", self.JAVA_CLASSPATH)
